return {
    ...
    keys = {
        ...
        -- CocList commands
        { '<leader>d', '<Cmd>CocList diagnostics<CR>', mode = 'n', silent = true, nowait = true,                    desc = 'Show all diagnostics' },
        { '<leader>e', '<Cmd>CocList extensions<CR>',  mode = 'n', silent = true, nowait = true,                    desc = 'Manage extensions' },
        { '<leader>c', '<Cmd>CocList commands<CR>',    mode = 'n', silent = true, nowait = true,                    desc = 'Show commands' },
        { '<leader>o', '<Cmd>CocList outline<CR>',     mode = 'n', silent = true, nowait = true,                    desc = 'Document outline' },
